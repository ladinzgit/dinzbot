...
class MusicPlayerView(discord.ui.View):
    ...
    def build_embed(self) -> discord.Embed:
        ...
        if not player or not player.current:
            ...
            embed.set_footer(text='DinzBot Music')
            return embed
        ...
        color = 0xf4d03f if paused else 0x1db954
        status = '⏸️  일시정지' if paused else '▶️  재생 중'
        ...
        embed.set_footer(text='DinzBot Music  ·  채널에 제목이나 링크를 입력하면 대기열에 추가됩니다')
        return embed
